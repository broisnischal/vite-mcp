...
const cacheAdapterOutputSchema = z.object({
  action: z.enum(["list", "get_keys", "get_entry", "set_entry", "delete_entry", "delete", "clear"]).describe("The action that was performed"),
  success: z.boolean().optional().describe("Whether the action was successful"),
  cacheNames: z.array(z.string()).optional().describe("Array of cache names (for list action)"),
  count: z.number().optional().describe("Number of caches or keys"),
  keys: z.array(z.string()).optional().describe("Array of request URLs/keys (for get_keys action)"),
  cacheName: z.string().optional().describe("Name of the cache"),
  key: z.string().optional().describe("The key that was used"),
  found: z.boolean().optional().describe("Whether the entry was found (for get_entry action)"),
  response: z
    .object({
      status: z.number().optional().describe("HTTP status code"),
      statusText: z.string().optional().describe("HTTP status text"),
    ...
    .optional()
    .describe("Cached response data (for get_entry action)"),
  deletedCount: z.number().optional().describe("Number of entries deleted (for clear action)"),
});
